...
class Reminder:
    def __init__(self, parent):
        # Embed Reminder in the provided parent frame
        self.frame = tk.CTkFrame(parent, fg_color="white")
        self.frame.pack(expand=True, fill=tk.BOTH,padx=10,pady=10)

        self.notification_label = tk.CTkLabel(
            self.frame, text="", fg_color="white", text_color="#57a1f8", font=("Microsoft YaHei UI Light", 12)
        )
        ...
        self.title = tk.CTkEntry(self.main_frame, text_color="#57a1f8", font=("Roboto", 16), fg_color="white")
        ...
        self.msg = tk.CTkEntry(self.main_frame, text_color="#57a1f8", font=("Roboto", 16), fg_color="white")
        ...
        self.set_button = tk.CTkButton(
            self.main_frame, text="SET NOTIFICATION", fg_color="#57a1f8", text_color="black", font=("Roboto", 16, "bold"),
    ...
    def show_notification(self, message):
        popup = tk.CTkToplevel(self.frame)
